...
describe('UpdateUserProfileController', () => {
  ...
  describe('User Story #13: UpdatedUserProfile', () => {
    const validArgs = ['profile-1', '1995-05-15', '456 New Ave', '98765432', 'account-1'] as const;
  ...
  describe('User Story #13: Get_Updated', () => {
    const mockRecord = {
      ...
      user_profile: { id: 'profile-1', dob: '1995-05-15', address: '456 New Ave', phone_number: '98765432' },
    };
