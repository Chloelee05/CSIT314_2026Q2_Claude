...
/**
 * User Story #25 — Donee search flow:
 * DoneeSearchActivityBoundary (UML: SearchActivityBoundary) renders process_search + show_results;
 * controller + entity run on the server below.
 */
