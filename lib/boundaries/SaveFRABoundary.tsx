...
/**
 * BCE Boundary: SaveFRABoundary (User Story #27)
 *
 * - showSaveResult()   — displays success/failure flash after save attempt
 * - displaySaveButton() — renders the save form button
 */
